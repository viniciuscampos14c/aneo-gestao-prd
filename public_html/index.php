...
$router->post('student/course/progress/complete', fn () => $studentPortal->confirmLessonCompletion());
...
$router->get('finance/payables', fn () => $finance->payables());
$router->post('finance/payables/store', fn () => $finance->storePayable());
$router->post('finance/payables/update', fn () => $finance->updatePayable());
$router->post('finance/payables/settle', fn () => $finance->settlePayable());
$router->post('finance/payables/cancel', fn () => $finance->cancelPayable());
$router->post('finance/payables/recurring', fn () => $finance->generateRecurringPayables());
$router->post('finance/payables/attachments/store', fn () => $finance->uploadPayableAttachment());
$router->post('finance/payables/attachments/delete', fn () => $finance->deletePayableAttachment());
$router->get('finance/payables/attachments/download', fn () => $finance->downloadPayableAttachment());
$router->get('finance/suppliers', fn () => $finance->suppliers());
$router->post('finance/suppliers/store', fn () => $finance->storeSupplier());
$router->post('finance/suppliers/toggle', fn () => $finance->toggleSupplier());
...
$router->get('courses/preview', fn () => $courses->preview());
$router->post('courses/update', fn () => $courses->update());
$router->post('courses/duplicate', fn () => $courses->duplicate());
$router->post('courses/status', fn () => $courses->updateStatus());
