 ...
 *   string $portalUrl
 *   string $logoUrl
 *   string $notificationType - 'published' ou 'result'
 *   bool   $isExternal
 *   string $scoreLabel
 *   string $passingScoreLabel
 *   string $resultStatus
 */

$notificationType = (string) ($notificationType ?? 'published');
$isResult = $notificationType === 'result';
$isExternal = !empty($isExternal);
...
<title><?= htmlspecialchars($statusLabel); ?></title>
</head>
  ...
  <tr>
    <td align="center">
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background-color:<?= htmlspecialchars($accent); ?>;padding:12px 32px;text-align:center;">
          ...
          <td style="background-color:#ffffff;padding:32px;">
              ...
              <tr>
                <td style="padding:20px 24px;">
                  <table width="100%" cellpadding="0" cellspacing="6" border="0">
                    <tr>
                      <td style="font-size:12px;color:#64748b;text-transform:uppercase;letter-spacing:0.05em;padding-bottom:2px;" width="40%">Curso</td>
                    ...
                    <?php if (!$isResult): ?>
                      <tr>
                        <td style="font-size:12px;color:#64748b;text-transform:uppercase;letter-spacing:0.05em;padding-bottom:2px;">Data</td>
                        <td style="font-size:14px;color:#1e293b;"><?= htmlspecialchars($dateLabel); ?></td>
                      </tr>
                      <tr>
                    ...
                    <?php else: ?>
                      <tr>
                        <td style="font-size:12px;color:#64748b;text-transform:uppercase;letter-spacing:0.05em;padding-bottom:2px;">Nota</td>
                        <td style="font-size:20px;color:#0f172a;font-weight:800;"><?= htmlspecialchars($scoreLabel); ?></td>
                      </tr>
                      <tr>
            ...
            <?php if ($portalUrl !== ''): ?>
              <table cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px;">
                <tr>
                  <td style="border-radius:10px;background-color:<?= htmlspecialchars($accentDark); ?>;">
