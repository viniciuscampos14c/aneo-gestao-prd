<section class="space-y-6">
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div>
            ...
            <p class="text-sm text-slate-500">Organize os plantoes praticos por unidade, semana e nivel de residencia.</p>
        </div>
            ...
            <div class="space-y-4">
                <form method="post" action="<?= route('escala-aluno/unit/store'); ?>" class="rounded-xl border border-slate-200 bg-white p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-xs text-slate-500">Cadastre a unidade onde o aluno realiza os plantões.</p>
                    </div>
                ...
                <div class="overflow-hidden rounded-xl border border-slate-200 bg-white">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody>
                            ...
                            <?php endforeach; ?>
                            <?php if ($units === []): ?>
                                <tr><td colspan="4" class="px-3 py-6 text-center text-slate-500">Nenhuma unidade cadastrada.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
                        ...
                        <tbody>
                            <?php foreach ($rows as $row): ?>
                                ...
                                <tr class="border-b border-slate-100">
                                    ...
                                    <td class="px-3 py-3"><?= e(date('d/m/Y', strtotime((string) $row['start_date']))); ?> até <?= e(date('d/m/Y', strtotime((string) $row['end_date']))); ?></td>
