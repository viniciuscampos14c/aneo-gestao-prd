...
try {
  ...
  await editForm.locator('input[name="category"]').fill('QA Operacional');
  await editForm.locator('input[name="due_date"]').fill('2026-05-31');
  await editForm.locator('input[name="amount"]').fill('455,55');
  await editForm.locator('input[name="notes"]').fill(`Fluxo editado e cancelado ${runId}`);
